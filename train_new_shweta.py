...
num_data_samples = 63916                                      
num_valid_samples = 52*50
data_dir = "/deepack/model_tailoring/tf_records/tailored_data/"
...
with tf.variable_scope('vgg_16'):
    ...
    W_fc8 = weight_variable([1,1,4096,1000],name="fc8/weights")
    b_fc8 = bias_variable([1000],name="fc8/biases")
...
lbl_one_hot = tf.one_hot(labels, 1000, 1.0, 0.0)
